          ...
          >
            {testimonials.map((person) => (
              ...
              >
                ...
                <span className="relative before:absolute before:w-7 before:h-7 before:bg-slate-50 before:rotate-45 flex justify-center shadow-2xl before:shadow-2xl before:dark:bg-slate-800"></span>
